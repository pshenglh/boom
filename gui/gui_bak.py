...
"}")
        ...
        item = QtWidgets.QTableWidgetItem()
        self.ResultTable.setItem(0, 4, item)
        ...
        self.CleanResult = QtWidgets.QAction(Form)
        self.CleanResult.setObjectName("CleanResult")
        self.CleanAll = QtWidgets.QAction(Form)
        self.CleanAll.setObjectName("CleanAll")
        self.Info = QtWidgets.QAction(Form)
        ...
        self.CleanMenu.addAction(self.CleanResult)
        self.CleanMenu.addAction(self.CleanAll)
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "B值范围"))
        ...
        item.setText(_translate("Form", "0"))
        item = self.ResultTable.item(0, 4)
        item.setText(_translate("Form", "0"))
        ...
        self.CleanResult.setText(_translate("Form", "清除表单"))
        self.CleanAll.setText(_translate("Form", "全部清除"))
        self.Info.setText(_translate("Form", "关于"))
